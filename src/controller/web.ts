...
export class WebController {
  ...
  public static setup(app: express.Express) {
    app.route('/')
      .get(this.OnGetIndex)
    app.route('/signup')
      .get(this.OnGetSignup)
    app.route('/login')
      .get(this.OnGetLogin)
    app.route('/logout')
      .get(this.OnGetLogout)
    app.route('/user')
      .get(this.OnGetUser)
    app.route('/user/delete')
      .get(this.OnGetUserDelete)
    app.route('/do_signup')
      .post(this.OnPostDoSignup)
    app.route('/do_login')
      .post(this.OnPostDoLogin)
    app.route('/do_delete')
      .post(this.OnPostDoDelete)
  }
   ...
   */
  private static redirectWithError(error: string, redirPage: string,
   ...
   */
  private static async OnGetIndex(req: express.Request, res: express.Response): Promise<void> {
   ...
   * @param res the response data
   */
  private static async OnGetSignup(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId != null) {
      return res.redirect('/user')
    }
   ...
   * @param res the response data
   */
  private static async OnGetLogin(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId != null) {
      return res.redirect('/user')
    }
   ...
   * @param res the response data
   */
  private static async OnGetLogout(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId != null) {
   ...
   * @param res the response data
   */
  private static async OnGetUser(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId == null) {
   ...
   * @param res the response data
   */
  private static async OnGetUserDelete(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId == null) {
      return res.redirect('/login')
    }
   ...
   * @param res the response data
   */
  private static async OnPostDoSignup(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId != null) {
      return res.redirect('/user')
    }
    ...
    if (userName == null
      ...
      return WebController.redirectWithError('A bad request was made.', '/signup', req, res)
    }

    if (password !== confirmedPassword) {
      return WebController.redirectWithError('The passwords are not the same.', '/signup', req, res)
    }
    ...
    try {
      ...
      WebController.redirectWithError('Bad credentials', '/signup', req, res)
    } catch (error) {
      if (error) {
        const errorMessage: string = error.toString()
        LogInstance.error(errorMessage)
        WebController.redirectWithError(errorMessage, '/signup', req, res)
      }
    }
  }
   ...
   * @param res the response data
   */
  private static async OnPostDoLogin(req: express.Request, res: express.Response): Promise<void> {
    if (req.session.userId != null) {
      return res.redirect('/user')
    }
    ...
    if (username == null
      || password == null) {
      return WebController.redirectWithError('A bad request was made.', '/login', req, res)
    }
    ...
    try {
      ...
      WebController.redirectWithError('Bad credentials', '/login', req, res)
    } catch (error) {
      if (error) {
        ...
        LogInstance.error(errorMessage)
        WebController.redirectWithError(errorMessage, '/login', req, res)
      }
    }
  }
   ...
   * @param res the response data
   */
  private static async OnPostDoDelete(req: express.Request, res: express.Response): Promise<void> {
    ...
    try {
      ...
      WebController.redirectWithError('Failed to delete account.', '/user', req, res)
    } catch (error) {
      if (error) {
        const errorMessage: string = error.toString()
        LogInstance.error(errorMessage)
